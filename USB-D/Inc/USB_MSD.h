...
*  Description
*    Callback function to prevent/allow removal of storage medium.
*    See USBD_MSD_SetPreventAllowRemovalHookEx().
*
*  Parameters
...
typedef struct {
  ...
  U16 SectorSize;             // Size of one sector.
} USB_MSD_INFO;
...
typedef struct {
  ...
  U8 InterfaceNum;        // Interface number. This member is normally internally used, so therefore the value shall be set to 0.
} USB_MSD_INIT_DATA;
...
*    != 0 - Failed.
*/
typedef char       (USB_MSD_STORAGE_READ)           (U8 Lun, U32 SectorIndex, void *   pData, U32 NumSectors);
/*********************************************************************
*
...
*    != 0 - Failed.
*/
typedef char       (USB_MSD_STORAGE_WRITE)          (U8 Lun, U32 SectorIndex, const void *   pData, U32 NumSectors);
/*********************************************************************
*
...
void USBD_MSD_SetPreventAllowRemovalHookEx(U8 Lun, PREVENT_ALLOW_REMOVAL_HOOK_EX * pfOnPreventAllowRemovalEx);
