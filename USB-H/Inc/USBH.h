...
#define USBH_VERSION   21800 // Format: Mmmrr. Example: 21800 is 2.18
...
#define USBH_MTYPE_AUDIO         (1UL << 26)
#define USBH_MTYPE_MIDI          (1UL << 27)
...
typedef struct {
  ...
  U32          Length2;       // [IN]  Length of the second data part to be transferred via ISO OUT EP in bytes.
