...
typedef struct {
  ...
  U32                   FileNameSize;   // The length of the file-name string.
  const U16           * sFileName;      // Pointer to the Unicode file-name string.
...
USBH_STATUS             USBH_MTP_Rename                 (USBH_MTP_DEVICE_HANDLE hDevice, U32 ObjectID, const U16 * sNewName, U32 NumChars);
