...
typedef struct {
  ...
  volatile GPIO_MODE_T  GPIO_Mode;     // Operating mode for the selected pins.
  volatile GPIO_SPEED_T GPIO_Speed;    // Speed for the selected pins.
  volatile GPIO_OTYPE_T GPIO_OType;    // Operating output type for the selected pins.
  volatile GPIO_PUPD_T  GPIO_PuPd;     // Operating Pull-up/Pull down for the selected pins.
} GPIO_INIT_T;
