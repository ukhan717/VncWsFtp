...
static const GUI_COLOR _aColor[8] = {
  GUI_MAKE_COLOR(0x000000),
  GUI_MAKE_COLOR(0x0000FF),
  GUI_MAKE_COLOR(0x00FF00),
  GUI_MAKE_COLOR(0x00FFFF),
  GUI_MAKE_COLOR(0xFF0000),
  GUI_MAKE_COLOR(0xFF00FF),
  GUI_MAKE_COLOR(0xFFFF00),
  GUI_MAKE_COLOR(0xFFFFFF)
};
