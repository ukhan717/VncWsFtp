...
void MainTask(void) {
  ...
  SEGGER_snprintf(_ac, sizeof(_ac), "  Volume name:       \"%s\"\n",    VOLUME_NAME);
  FS_X_Log(_ac);
  SEGGER_snprintf(_ac, sizeof(_ac), "  Number of sectors: %lu\n",       DevInfo.NumSectors);
  FS_X_Log(_ac);
  SEGGER_snprintf(_ac, sizeof(_ac), "  Sector size:       %lu bytes\n", BytesPerSector);
  FS_X_Log(_ac);
  //
  ...
  //
  SEGGER_snprintf(_ac, sizeof(_ac), "Write, read and verify sector %lu\n", (long unsigned)SECTOR_INDEX);
  FS_X_Log(_ac);
