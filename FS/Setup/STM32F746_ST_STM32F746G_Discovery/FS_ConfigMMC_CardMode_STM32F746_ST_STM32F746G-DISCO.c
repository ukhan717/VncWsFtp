...
**********************************************************************
----------------------------------------------------------------------
File        : FS_ConfigMMC_CardMode_STM32F746_ST_STM32F746G-DISCO.c
Purpose     : Configuration functions for FS with MMC/SD card mode driver
---------------------------END-OF-HEADER------------------------------
*/

#include "FS.h"
#include "FS_MMC_CM_HW_STM32F746_ST_STM32F746G-DISCO.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_MMC_CM_SetHWType(0, &FS_MMC_HW_CM_STM32F746_ST_STM32F746G_DISCO);
  //
